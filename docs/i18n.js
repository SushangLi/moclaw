const translations = {
  ko: {
    'meta.title': 'MoClaw — OpenClaw 원클릭 설치 프로그램',
    'meta.description':
      'MoClaw로 OpenClaw AI 에이전트를 원클릭 설치하세요. Windows & macOS 지원.',
    'nav.download': '다운로드',
    'hero.tagline':
    ...
    'steps.install.desc': 'MoClaw가 환경을 감지하고<br />필요한 것만 자동 설치',
    ...
    'crossBanner.claw.title': 'MoClaw',
    'crossBanner.claw.desc': 'OpenClaw AI 에이전트도 원클릭으로 설치해보세요',
    'crossBanner.claw.btn': 'MoClaw 보기'
  },
  en: {
    'meta.title': 'MoClaw — One-Click OpenClaw Installer',
    'meta.description':
      'Install the OpenClaw AI agent with one click using MoClaw. Supports Windows & macOS.',
    ...
    'steps.install.desc': 'MoClaw detects your environment<br />and auto-installs what you need',
    ...
    'crossBanner.claw.btn': 'View MoClaw'
  },
  ja: {
    'meta.title': 'MoClaw — OpenClaw ワンクリックインストーラー',
    'meta.description':
      'MoClawでOpenClaw AIエージェントをワンクリックインストール。Windows & macOS対応。',
    'nav.download': 'ダウンロード',
    'hero.tagline':
    ...
    'steps.install.desc': 'MoClawが環境を検出し<br />必要なものだけ自動インストール',
    ...
    'crossBanner.claw.btn': 'MoClawを見る'
  },
  zh: {
    'meta.title': 'MoClaw — OpenClaw 一键安装程序',
    'meta.description': '使用MoClaw一键安装OpenClaw AI代理。支持Windows和macOS。',
    'nav.download': '下载',
    'hero.tagline':
    ...
    'steps.install.desc': 'MoClaw检测环境<br />自动安装所需组件',
