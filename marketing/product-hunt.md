...
- **Website**: https://moclaw.kr
- **GitHub**: https://github.com/SushangLi/moclaw

## Description (Short)

MoClaw is a free, open-source desktop app that installs OpenClaw AI agent in three steps: download, run, and enter your API key. No terminal commands needed. Supports macOS and Windows.
...
MoClaw eliminates all that complexity. It's a desktop installer that:
...
I'm the maker of MoClaw. I built this because I kept seeing people in the OpenClaw community struggle with the installation process — especially on Windows, where you need WSL set up properly.
