...
I kept seeing people in the community give up halfway through the setup. So I built **MoClaw** — a desktop app that handles the entire installation in three clicks.

## What it does

**Download → Run → Enter your API key.** That's the whole process.

MoClaw automatically:
...
![Welcome](https://raw.githubusercontent.com/SushangLi/moclaw/main/docs/screenshots/welcome.png)
![Environment Check](https://raw.githubusercontent.com/SushangLi/moclaw/main/docs/screenshots/env-check.png)
![Done](https://raw.githubusercontent.com/SushangLi/moclaw/main/docs/screenshots/done.png)

## Try it out

- **Download**: [macOS (.dmg)](https://github.com/SushangLi/moclaw/releases/latest/download/moclaw.dmg) | [Windows (.exe)](https://github.com/SushangLi/moclaw/releases/latest/download/moclaw-setup.exe)
- **GitHub**: [github.com/SushangLi/moclaw](https://github.com/SushangLi/moclaw)
- **Website**: [moclaw.kr](https://moclaw.kr)
