...
<p align="center">
  <a href="https://moclaw.kr">홈페이지</a> · <a href="https://github.com/SushangLi/moclaw/releases/latest">다운로드</a> · <a href="https://open.kakao.com/o/gbBkPehi">커뮤니티</a> · <a href="https://github.com/openclaw/openclaw">OpenClaw</a>
</p>
...
| OS      | 파일   | 링크                                                                                          |
| ------- | ------ | --------------------------------------------------------------------------------------------- |
| macOS   | `.dmg` | [다운로드](https://github.com/SushangLi/moclaw/releases/latest/download/moclaw.dmg)       |
| Windows | `.exe` | [다운로드](https://github.com/SushangLi/moclaw/releases/latest/download/moclaw-setup.exe) |

[moclaw.kr](https://moclaw.kr)에서도 OS에 맞는 파일이 자동으로 선택됩니다.
