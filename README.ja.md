...
<p align="center">
  <a href="https://moclaw.kr">ウェブサイト</a> · <a href="https://github.com/SushangLi/moclaw/releases/latest">ダウンロード</a> · <a href="https://github.com/openclaw/openclaw">OpenClaw</a>
</p>
...
MoClawは、[OpenClaw](https://github.com/openclaw/openclaw) AIエージェントを**ターミナル操作なしで**セットアップできるデスクトップインストーラーです。
...
| OS      | ファイル | リンク                                                                                            |
| ------- | -------- | ------------------------------------------------------------------------------------------------- |
| macOS   | `.dmg`   | [ダウンロード](https://github.com/SushangLi/moclaw/releases/latest/download/moclaw.dmg)       |
| Windows | `.exe`   | [ダウンロード](https://github.com/SushangLi/moclaw/releases/latest/download/moclaw-setup.exe) |

[moclaw.kr](https://moclaw.kr)からもOSに合わせたファイルを自動選択できます。
