...
<p align="center">
  <a href="https://moclaw.kr">官网</a> · <a href="https://github.com/SushangLi/moclaw/releases/latest">下载</a> · <a href="https://github.com/openclaw/openclaw">OpenClaw</a>
</p>
...
MoClaw 是一个桌面安装器，可以**无需任何终端命令**即可设置 [OpenClaw](https://github.com/openclaw/openclaw) AI 代理。
...
| 操作系统 | 文件   | 链接                                                                                      |
| -------- | ------ | ----------------------------------------------------------------------------------------- |
| macOS    | `.dmg` | [下载](https://github.com/SushangLi/moclaw/releases/latest/download/moclaw.dmg)       |
| Windows  | `.exe` | [下载](https://github.com/SushangLi/moclaw/releases/latest/download/moclaw-setup.exe) |

也可以从 [moclaw.kr](https://moclaw.kr) 下载 — 会自动检测您的操作系统。
