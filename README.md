<p align="center">
  <img src="resources/icon.png" width="120" alt="MoClaw Logo">
</p>
...
<p align="center">
  <a href="https://github.com/SushangLi/moclaw/releases/latest"><img src="https://img.shields.io/github/v/release/SushangLi/moclaw?color=f97316&style=flat-square" alt="Release"></a>
  <a href="https://github.com/SushangLi/moclaw/releases"><img src="https://img.shields.io/github/downloads/SushangLi/moclaw/total?color=34d399&style=flat-square" alt="Downloads"></a>
  <img src="https://img.shields.io/badge/platform-macOS%20%7C%20Windows-blue?style=flat-square" alt="Platform">
  <a href="LICENSE"><img src="https://img.shields.io/badge/license-MIT-8b5cf6?style=flat-square" alt="License"></a>
</p>

<p align="center">
  <a href="https://moclaw.kr">Website</a> · <a href="https://github.com/SushangLi/moclaw/releases/latest">Download</a> · <a href="https://github.com/openclaw/openclaw">OpenClaw</a>
</p>

---

<p align="center">
  <img src="docs/demo.gif" width="600" alt="MoClaw Demo">
</p>

## What is MoClaw?

MoClaw is a desktop installer that sets up [OpenClaw](https://github.com/openclaw/openclaw) AI agent **without any terminal commands**.
...
| OS      | File   | Link                                                                                          |
| ------- | ------ | --------------------------------------------------------------------------------------------- |
| macOS   | `.dmg` | [Download](https://github.com/SushangLi/moclaw/releases/latest/download/moclaw.dmg)       |
| Windows | `.exe` | [Download](https://github.com/SushangLi/moclaw/releases/latest/download/moclaw-setup.exe) |

You can also download from [moclaw.kr](https://moclaw.kr) — it auto-detects your OS.
