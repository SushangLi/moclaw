...
MoClaw uses free code signing provided by [SignPath Foundation](https://signpath.org).
...
MoClaw does not collect, transmit, or store any personal data. The application runs entirely on the user's local machine. No telemetry, analytics, or tracking of any kind is included.
